package com.example.tamangfoodservicetest.presentation.view.welcome
...
import com.example.tamangfoodservicetest.databinding.ActivityWelcomeBinding
import com.example.tamangfoodservicetest.presentation.view.login.LoginActivity
...
class WelcomeActivity : AppCompatActivity() {
    ...
    private fun dotsIndicator() {
        ...
        for(i in mDots.indices){
            ...
            mDots[i].apply {
                this?.setImageDrawable(ContextCompat.getDrawable(applicationContext,R.drawable.indicator1_inactive))
    ...
    fun setDots(index : Int){
        ...
        for (i in 0 until childCount){
            ...
            if (i == index){
                imageView.setImageDrawable(ContextCompat.getDrawable(applicationContext, R.drawable.indicator1_active))
            }
            else imageView.setImageDrawable(ContextCompat.getDrawable(applicationContext,R.drawable.indicator1_inactive))
        }
    }
